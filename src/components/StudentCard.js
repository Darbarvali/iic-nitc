...
function StudentCard() {
      ...
      <div id="studentcard">
         <span>
            <i className="bg fa-solid fa-people-group"></i>
                <h2 id="team">Student Representatives  of IIC 4.0</h2>
            </span>
            
         <section class="profiles">
  <a ><img src="students/Santo.png" alt=""/>
  ...
  <a ><img src="students/Ben Thomas.jpg" alt=""/>
    ...
    <div className='name'>
      ...
      <a href="https://www.linkedin.com/in/ben-thomas-1375a8144/" > <LinkedInIcon /> </a>
...
<div className='name'>
  ...
  <a href="https://www.linkedin.com/in/siva-kumar-thota-09a435224" > <LinkedInIcon /> </a>
