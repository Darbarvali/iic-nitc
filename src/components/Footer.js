  ...
  return (
    <MDBFooter className="text-center text-lg-start text-muted" id="footer">
        ...
        <div className="container text-center text-md-start mt-5">
          <div className="row mt-3">
            ...
            <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
              ...
              <p>
                <a href="https://www.linkedin.com/feed/?trk=onboarding-landing" className="text-reset">
                  Linked In
                </a>
              </p>
              <p>
                <a href="https://mobile.twitter.com/iicnitc" className="text-reset">
                  Twitter
                </a>
              </p>
              <p>
                <a href="https://www.instagram.com/iic_nitcalicut/" className="text-reset">
                  Instagram
                </a>
              </p>
            </div>
            ...
            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <p>
                <i className="fas fa-home me-3"></i> NIT Calicut{" "}
              </p>
              <p>
      ...
      >
        ...
        <a className="text-reset fw-bold" href="http://www.nitc.ac.in/">NITC</a>
      </div>
    </MDBFooter>
  );
}
